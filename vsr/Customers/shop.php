  ...
  <div id="wrapper">
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li class="active"><a href="shop.php?id=1"> &nbsp;</span> Купить сейчас</a></li>
    ...
    <div id="page-wrapper">
      ...
      <div class="alert alert-default" style="color:white;background-color:#008CBA">
        <center>
          <h3>Здесь представлены все товары которые мы можем предоставить вам в данный момент!</h3>
        </center>
      </div>
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>" . $query2['item_name'] . "</textarea>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/" . $query2['item_image'] . "' data-fancybox-group='button' title='Page " . $id . "- " . $query2['item_name'] . "'>
					...
					<center><h4> Описание: " . $query2['item_qwe'] . " </h4></center>
										...
										<a class='btn btn-block btn-danger' href='add_to_cart.php?cart=" . $query2['item_id'] . "'></span> Добавить в корзину</a>
            </div>
          </div>
        </div>";
      }
      ...
      if ($id > 1) {
        echo "<li><a style='color:white;background-color : #033c73;' href='?id=" . ($id - 1) . "'>Прошлая страница</a><li>";
      }
      if ($id != $total) {
        echo "<li><a style='color:white;background-color : #033c73;' href='?id=" . ($id + 1) . "' class='pager'>Следующая страница</a></li>";
      }
      echo "</ul>";
